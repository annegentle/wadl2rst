=============================================================================
Get Default Quotas -  OpenStack Compute API v2.1
=============================================================================

Get Default Quotas
~~~~~~~~~~~~~~~~~~~~~~~~~

`Request <GET_get_default_quotas_v2_tenant_id_os-quota-sets_defaults.rst#request>`__
`Response <GET_get_default_quotas_v2_tenant_id_os-quota-sets_defaults.rst#response>`__
...
**Example Get default quotas response: JSON**
...
**Example Get default quotas response: XML**
