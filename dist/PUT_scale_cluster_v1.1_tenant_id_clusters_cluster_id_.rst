=============================================================================
Scale Cluster -  OpenStack Compute API v2.1
=============================================================================

Scale Cluster
~~~~~~~~~~~~~~~~~~~~~~~~~

`Request <PUT_scale_cluster_v1.1_tenant_id_clusters_cluster_id_.rst#request>`__
`Response <PUT_scale_cluster_v1.1_tenant_id_clusters_cluster_id_.rst#response>`__

.. code-block:: javascript

    PUT /v1.1/{tenant_id}/clusters/{cluster_id}
...
**Example Scale cluster: JSON request**
